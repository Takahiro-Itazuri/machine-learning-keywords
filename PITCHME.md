...
`$$ {\bf w} = \methop{\rm arg~min}\limits_{\bf w} \frac{1}{2} \| {\bf Xw} - {\bf y} \|^2 + \lambda |{\bf w}| $$`
...
`$$ {\bf w} = \methop{\rm arg~min}\limits_{\bf w} \frac{1}{2} \| {\bf Xw} - {\bf y} \|^2 + \lambda \| {\bf w} \|^2 $$`
Ridge Regression can be solved analytically.
